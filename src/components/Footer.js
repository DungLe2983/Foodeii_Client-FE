            ...
            <div className='mx-auto w-full max-w-screen-2xl'>
                <div className='grid grid-cols-2 gap-8 px-8 py-6 lg:py-8 md:grid-cols-3'>
                    <div>
                        ...
                        <p className='text-gray-500 dark:text-gray-400 font-medium text-sm leading-7 '>
                            A user-friendly food discovery platform that offers
                            personalized recommendations, detailed product
                            information, and the latest reviews. Explore fresh
                            ingredients, uncover hidden culinary gems, and
                            effortlessly create your shopping list with{' '}
                            <span className='text-gray-300'>Foodeii</span>
                        </p>
                    </div>
                ...
                <div className='px-4 py-6 bg-gray-900 md:flex md:items-center md:justify-between'>
                    <span className='text-sm text-gray-300 sm:text-center'>
                        © 2024 <a href='https://flowbite.com/'>Foodeii</a>. All
                        Rights Reserved.
                    </span>
